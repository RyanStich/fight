...
//         console.log(gltf)
//         gltf.scene.position.set( 1.2, -0.9, 1.4 )
//         gltf.scene.scale.set(0.375, 0.375, 0.375)
//         const light = new THREE.AmbientLight( 0x404040, 3 ); // soft white light
//         scene.add( light );
//         const pointLight = new THREE.PointLight(0xff9000, 0.15)
//         scene.add(pointLight)
//         gltf.scene.rotation.x = Math.PI * 2.05
//         scene.add(gltf.scene)
//     }
// )
// const directionalLight = new THREE.DirectionalLight('#87CEFF', 5)
...
// const directionalLight1 = new THREE.DirectionalLight('#f20fbd', 3)
// directionalLight.castShadow = true
// directionalLight.shadow.camera.far = 15
// directionalLight.shadow.mapSize.set(1024, 1024)
// directionalLight.shadow.normalBias = 0.05
