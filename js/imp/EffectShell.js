class EffectShell {
  ...
  setup() {
    ...
    var canny = document.querySelector('canvas.imager');
    var square = document.querySelector('section.app');

    // renderer
    this.renderer = new THREE.WebGLRenderer({ antialias: true, alpha: true, canvas: canny })
